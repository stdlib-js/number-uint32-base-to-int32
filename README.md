...
```javascript
import uint32ToInt32 from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base-to-int32@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/number-uint32-base-to-int32/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/number-uint32-base-to-int32/actions/workflows/test.yml?query=branch:v0.2.2
