...
```javascript
uint32ToInt32 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base-to-int32@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base-to-int32@umd/bundle.js"></script>
```
